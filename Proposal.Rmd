...
setwd('https://github.com/benjaminsnow/Collaborative-Research-Proposal-Assignment-Two-/')

# Install and load packages & create .bib BibTeX file
install.packages("ggplot2", "repmis", "devtools", "WDI")
require("devtools")
